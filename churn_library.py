"""
This script is used for modelling the churn_prediction for bank dataset
Artifact files will be stored in models folder
...
if __name__ == "__main__":
    ...
    logger.info("Performing EDA on the loaded dataset")
    perform_eda(DF)
    logger.info("Encoding the categorical columns in dataset")
    DF_ENCODE = encoder_helper(DF, category_lst=["Gender",
                                                 "Education_Level",
                                                 "Marital_Status",
                                                 "Income_Category",
                                                 "Card_Category"],
    ...
    logger.info("Perform Feature Engineering and creating train test dataset")
    X_TRAIN, X_TEST, Y_TRAIN, Y_TEST = perform_feature_engineering(
        DF_ENCODE, response="Churn")

    logger.info("modelling and results")
